...
class GoogleMeetController extends PostsController {
	...
	public function get_items_permissions_check( $request ) {
		...
		if ( ! current_user_can( 'get_google_meets' ) ) {
			return new \WP_Error(
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( $post && in_array( $post->post_type, array_merge( CourseChildrenPostType::all(), array( PostType::GOOGLEMEET ) ), true ) ) {
		...
		if ( masteriyo_can_start_course( $course ) && post_password_required( get_post( $course->get_id() ) ) ) {
			return new \WP_Error(
				'masteriyo_rest_cannot_start_course',
