...
class Capabilities {
	...
	public static function get_instructor_capabilities() {
		$capabilities = array(
			...
			// Google Meet
			'publish_google_meets'              => true,
			'edit_google_meets'                 => true,
			'edit_private_google_meets'         => true,
			'edit_published_google_meets'       => true,
			'delete_google_meets'               => true,
			'delete_published_google_meets'     => true,
			'delete_private_google_meets'       => true,
		);
	...
	public static function get_manager_capabilities() {
		$capabilities = array(
			...
			// Google Meet
			'edit_others_google_meets'         => true,
			'delete_others_google_meets'       => true,
		);
